...
A: 16.875 (calculation with the linear scale of 4 years dissolve and 2 years locked). The linear scale is calculated as; (y2-y1)/(x2-x1); (96-6)/(2-1,06)=0.01 ; 0.01* 48=0.5. 1+0.5=1.5; 1.5* 10* 1.125=16.875
